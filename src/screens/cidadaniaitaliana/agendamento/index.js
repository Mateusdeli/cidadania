        ...
        <Wrapper>
            <Wrapper.Content>
                <Info>
                    ...
                    <Text className="pt-3" weight="400" size="16px" line="32px">3RICIAS CIDADANIA ITALIANA é uma empresa de assessoria completa para que você possa realizar seus objetivos em ser um cidadão europeu.</Text>
                    <Link href="#">
